...
export const generateInvoicePDF = (invoice) => {
  ...
  doc.setFont('helvetica', 'bold');
  doc.setFontSize(8);
  doc.text('Generated by Spend Buddy Finance - Privacy-focused financial management', 20, footerY + 8);
...
export const downloadInvoice = (invoice) => {
  ...
  const fileName = `Spend-Buddy-Invoice-${invoice.id.slice(-8).toUpperCase()}.pdf`;
  doc.save(fileName);
};